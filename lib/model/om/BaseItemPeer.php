...
abstract class BaseItemPeer {
	...
	/** the column name for the ATOMID field */
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'FeedId', 'Atomid', 'Title', 'Link', 'Description', 'Published', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'feedId', 'atomid', 'title', 'link', 'description', 'published', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FEED_ID, self::ATOMID, self::TITLE, self::LINK, self::DESCRIPTION, self::PUBLISHED, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'feed_id', 'atomid', 'title', 'link', 'description', 'published', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'FeedId' => 1, 'Atomid' => 2, 'Title' => 3, 'Link' => 4, 'Description' => 5, 'Published' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'feedId' => 1, 'atomid' => 2, 'title' => 3, 'link' => 4, 'description' => 5, 'published' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FEED_ID => 1, self::ATOMID => 2, self::TITLE => 3, self::LINK => 4, self::DESCRIPTION => 5, self::PUBLISHED => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'feed_id' => 1, 'atomid' => 2, 'title' => 3, 'link' => 4, 'description' => 5, 'published' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ItemPeer::FEED_ID);

		$criteria->addSelectColumn(ItemPeer::ATOMID);

		$criteria->addSelectColumn(ItemPeer::TITLE);

		$criteria->addSelectColumn(ItemPeer::LINK);

		$criteria->addSelectColumn(ItemPeer::DESCRIPTION);

		$criteria->addSelectColumn(ItemPeer::PUBLISHED);
    ...
    foreach (sfMixer::getCallables('BaseItemPeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BaseItemPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseItemPeer', $criteria, $con);
    }
	...
	public static function doCountJoinFeed(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ItemPeer::FEED_ID,), array(FeedPeer::ID,), $join_behavior);
	...
	/**
	 * Selects a collection of Item objects pre-filled with their Feed objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseItemPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseItemPeer', $c, $con);
		...
		$c->addJoin(array(ItemPeer::FEED_ID,), array(FeedPeer::ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Item) to $obj2 (Feed)
				$obj2->addItem($obj1);
    ...
    foreach (sfMixer::getCallables('BaseItemPeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BaseItemPeer', $c, $con);
    }
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Item) to the collection in $obj2 (Feed)
				$obj2->addItem($obj1);
  ...
  {
    return array(array('atomid'), array('link'));
  }
	/**
