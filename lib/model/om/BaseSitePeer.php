...
abstract class BaseSitePeer {
	...
	const CLASS_DEFAULT = 'lib.model.Site';
	...
	/**
	 * An identiy map to hold any loaded instances of Site objects.
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Baseurl', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'baseurl', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TITLE, self::BASEURL, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'baseurl', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Baseurl' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'baseurl' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITLE => 1, self::BASEURL => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'baseurl' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new SiteMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SitePeer::BASEURL);
    ...
    foreach (sfMixer::getCallables('BaseSitePeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseSitePeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseSitePeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseSitePeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
	...
	{
		return SitePeer::CLASS_DEFAULT;
	}

	/**
	 * Method perform an INSERT on the database, given a Site or Criteria object.
	 *
    ...
    foreach (sfMixer::getCallables('BaseSitePeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseSitePeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseSitePeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseSitePeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Site or Criteria object.
	 *
    ...
    foreach (sfMixer::getCallables('BaseSitePeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseSitePeer', $values, $con);
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(SitePeer::ID, $criteria->remove(SitePeer::ID), $comparison);
    ...
    foreach (sfMixer::getCallables('BaseSitePeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseSitePeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the site table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += BasePeer::doDeleteAll(SitePeer::TABLE_NAME, $con);
			$con->commit();
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
	...
	/**
	 * Method perform a DELETE on the database, given a Site or Criteria object OR a primary key value.
	 *
	 ...
	 */
	public static function doValidate(Site $obj, $cols = null)
	{
		$columns = array();
		...
		$res =  BasePeer::doValidate(SitePeer::DATABASE_NAME, SitePeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = SitePeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
//
// NOTE: This static code cannot call methods on the SitePeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the SitePeer class:
//
// Propel::getDatabaseMap(SitePeer::DATABASE_NAME)->addTableBuilder(SitePeer::TABLE_NAME, SitePeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseSitePeer::DATABASE_NAME)->addTableBuilder(BaseSitePeer::TABLE_NAME, BaseSitePeer::getMapBuilder());
