...
abstract class BaseFeedPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Link', 'Website', 'Type', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'link', 'website', 'type', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TITLE, self::LINK, self::WEBSITE, self::TYPE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'link', 'website', 'type', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Link' => 2, 'Website' => 3, 'Type' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'link' => 2, 'website' => 3, 'type' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITLE => 1, self::LINK => 2, self::WEBSITE => 3, self::TYPE => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'link' => 2, 'website' => 3, 'type' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new FeedMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(FeedPeer::WEBSITE);

		$criteria->addSelectColumn(FeedPeer::TYPE);
    ...
    foreach (sfMixer::getCallables('BaseFeedPeer:doCount:doCount') as $callable)
    {
      call_user_func($callable, 'BaseFeedPeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BaseFeedPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BaseFeedPeer', $criteria, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseFeedPeer:doInsert:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseFeedPeer', $values, $con);
      if (false !== $ret)
      {
        return $ret;
      }
    ...
    foreach (sfMixer::getCallables('BaseFeedPeer:doInsert:post') as $callable)
    {
      call_user_func($callable, 'BaseFeedPeer', $values, $con, $pk);
    }
    ...
    foreach (sfMixer::getCallables('BaseFeedPeer:doUpdate:pre') as $callable)
    {
      $ret = call_user_func($callable, 'BaseFeedPeer', $values, $con);
      if (false !== $ret)
      {
    ...
    foreach (sfMixer::getCallables('BaseFeedPeer:doUpdate:post') as $callable)
    {
      call_user_func($callable, 'BaseFeedPeer', $values, $con, $ret);
    }
	...
	public static function doValidate(Feed $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(FeedPeer::DATABASE_NAME, FeedPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = FeedPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
        }
    }
...
//
// NOTE: This static code cannot call methods on the FeedPeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the FeedPeer class:
//
// Propel::getDatabaseMap(FeedPeer::DATABASE_NAME)->addTableBuilder(FeedPeer::TABLE_NAME, FeedPeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BaseFeedPeer::DATABASE_NAME)->addTableBuilder(BaseFeedPeer::TABLE_NAME, BaseFeedPeer::getMapBuilder());
